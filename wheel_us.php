...
<style type="text/css">
    ...
    .the_wheel
    {
        background-image: url(https://oct.bm3group.com/wp-content/plugins/orbitwheel/en.png);
    ...
    <div align="center" id="main-container">
        <div>
            <div id="wheel-arrow">
                ...
                <br/>
                <div>
                    <a href="#" class="orbit-button" id="play-button" onclick="startSpin();">Spin to win</a>
...
<script>
    ...
    */
            ...
            function resetWheel() {
                ...
                playButton.innerHTML = 'Spin to Win';
